<section class="bg-blue-700">
	<div class="max-w-2xl mx-auto py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
		...
		<p class="mt-4 text-xl leading-6 text-blue-100">
			...
			mission-driven organization that's making a positive impact on the world, particularly in wildlife conservation.
		</p>
		<p class="mt-4 text-xl leading-6 text-blue-100">
			Sound like you? <a class="font-bold underline" href="mailto:@tmciesco@gmail.com">Get in touch!</a>.
		</p>
	</div>
</section>
